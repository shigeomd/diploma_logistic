...
Процедура СправочникиПриЗаписи(Источник, Отказ) Экспорт
	...
	Если СтруктураУзелОбмена.ЦентральныйОфис Тогда
...
Функция ВыгрузитьСправочникиНаСервер() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОценкаПроизводительности") Тогда
		МодульОценкаПроизводительности = ОбщегоНазначения.ОбщийМодуль("ОценкаПроизводительности");
		МодульОценкаПроизводительности.ЗакончитьЗамерВремениТехнологический("ВыгрузкаСправочниковНаСервер", НачалоЗамера);
	КонецЕсли;
...
Функция ВыгрузитьДокументыНаСервер() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОценкаПроизводительности") Тогда
		МодульОценкаПроизводительности = ОбщегоНазначения.ОбщийМодуль("ОценкаПроизводительности");
		МодульОценкаПроизводительности.ЗакончитьЗамерВремениТехнологический("ВыгрузкаДокументовНаСервер", НачалоЗамера);
	КонецЕсли;
...
Функция ЗагрузитьСправочникиССервера() Экспорт
	...
	СтруктураРезультат =  ЗагрузитьОбъектыНаСервер(СтруктураУзелОбмена);
	
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОценкаПроизводительности") Тогда
		МодульОценкаПроизводительности = ОбщегоНазначения.ОбщийМодуль("ОценкаПроизводительности");
		МодульОценкаПроизводительности.ЗакончитьЗамерВремениТехнологический("ЗагрузкаСправочниковНаСервер", НачалоЗамера);
	КонецЕсли;
...
Функция ЗагрузитьДокументыССервера() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОценкаПроизводительности") Тогда
		МодульОценкаПроизводительности = ОбщегоНазначения.ОбщийМодуль("ОценкаПроизводительности");
		МодульОценкаПроизводительности.ЗакончитьЗамерВремениТехнологический("ЗагрузкаДокументовНаСервер", НачалоЗамера);
	КонецЕсли;
